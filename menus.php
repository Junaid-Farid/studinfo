...
<!---end  instructor-->
	...
	<dl class="dropdown">
        ...
        <dl class="dropdown">
				  ...
				  <dd id="eight-ddcontent" onmouseover="cancelHide('eight')" onmouseout="ddMenu('eight',-1)">
					<ul>
                      ...
                      <li><a href="add_room.php" class="underline">Add Room</a></li>
					  <li><a href="room_list.php" class="underline">List of Room</a></li>
		...
		<dl class="dropdown"> 
		  <dt id="four-ddheader" onmouseover="ddMenu('four',1)" onmouseout="ddMenu('four',-1)">Program</dt>
		  <dd id="four-ddcontent" onmouseover="cancelHide('four')" onmouseout="ddMenu('four',-1)">
			<ul>
			  <li><a href="add_course.php" class="underline">Add Program</a></li>
			  <li><a href="dept.php" class="underline">List of Programs</a></li>
...
<?php
 ...
 <?php 
	...
	<dl class="dropdown">
        ...
        <dl class="dropdown">
		  <dt id="seven-ddheader" onmouseover="ddMenu('seven',1)" onmouseout="ddMenu('seven',-1)">Notice</dt>
		  <dd id="seven-ddcontent" onmouseover="cancelHide('seven')" onmouseout="ddMenu('seven',-1)">
			<ul>
			  <li><a href="notice_files.php" class="underline">Add New Notice</a></li>
              <li><a href="notice_list.php" class="underline">View Notice</a></li>
              <li><a href="add_schedule.php" class="underline">Add Schedule</a></li>
              <li><a href="time_table.php" class="underline">View Schedule</a></li>
