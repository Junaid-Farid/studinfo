    ...
    <?php
					...
					<?php
				     	...
				     	$query = "INSERT INTO student
								(s_id, s_name, s_address, s_age, s_bday, s_bplace, sex, s_status, s_contact, s_email, s_password, s_guardian, course_id, s_guardian_add, s_guardian_contact, s_g_email, sy,semester, yr)
