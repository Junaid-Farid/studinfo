		...
		$rec_count = @$row[0];
		 ...
		 $query = "SELECT * FROM users ".
					...
					while ($row = mysql_fetch_array($result)) {
						...
						echo '<a href="process_del_user.php?id='.$row['user_id'].'" class="app_listitem_key "title="Delete"><img src="img_icon\Trash.ico" width="30" height="30"/></a> ';
						echo ' <a href="edit_user.php?id='.$row['user_id'].'" class="app_listitem_key" title="Edit"><img src="img_icon\write.ico" width="30" height="30"/></a>';
