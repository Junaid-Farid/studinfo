...
<div id="content">
	<?php $PHP_SELF = $_SERVER["PHP_SELF"]; ?>
		...
		$rec_count = @$row[0];
		 ...
		 $query = "SELECT * FROM stud_course ".
					"LIMIT  $offset, $rec_limit";
							...
							@$odd = !$odd;
								echo ' <td> ';
								echo '<a href="edit_student.php?id='.$row['s_id'].'" class="app_listitem_key" title="Edit">'.$row['s_id'].'</a>';
								echo ' <td> ';
								echo $row['s_name'];
								echo ' <td> ';
								echo $row['s_address'];
								...
								//echo $row['sy'];
								echo ' <td> ';
							echo '<a href="process_del_student.php?id='.$row['s_id'].'" class="app_listitem_key" title="Delete"><img src="img_icon\Trash.ico" width="30" height="30"/></a>';
		...
		<?php
					...
					{
					   echo "<a class=\"link-next\" href=\"$PHP_SELF?page=$page\" title='Next'><img src=\"img_icon\\next.ico\" width='30' height='20'/></a>";
					}
