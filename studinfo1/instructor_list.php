		...
		$rec_count = @$row[0];
		 ...
		 $query = "SELECT * FROM instructor ".
					"LIMIT  $offset, $rec_limit";
							...
							@$odd = !$odd;
								echo ' <td> ';
								echo '<a href="edit_instructor.php?id='.$row['instruc_id'].'" class="app_listitem_key">'.$row['instruc_id'].'</a>';
								echo ' <td> ';
								echo $row['name'];
								echo ' <td> ';
								echo $row['address'];
							...
							echo ' <td> ';
							echo '<a href="process_del_instructor.php?id='.$row['instruc_id'].'" class="app_listitem_key">[Delete Entry]</a>';
